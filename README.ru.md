...
## Описание
  TestQuizApp — приложение для прохождения коротких викторин. Пользователь может запустить викторину в любое время, пройти 5 вопросов (в зависимости от сложности) и сохранить результат. Также доступна история предыдущих попыток с возможностью просмотра деталей.
...
## Особенности (клиент)
  - Квиз по категориям с 3 видами сложностями (градация времени в зависимости от сложности)
  - История с кратким описанием и датой
  - Моментальная проверка ответа
...
## Особенности (разработка)
  ...
  - 19 UNIT тестов, куда входит:
      ...
      - 4️⃣ тесты мапперов слоя данных.
